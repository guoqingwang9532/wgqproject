...
<div class="pd-20" style="padding-top:20px;">
  <span class="f-20 text-success">欢迎<?php echo ($data['username']); ?> 登录</span><span style="margin-left: 450px;font-size: 14px">您所在的城市是：<?php echo ($addres2); ?></span><span style="margin-left: 20px; font-size: 14px">天气是：<?php echo ($detailWeather); ?></span>
  <p>登录次数：<?php echo ($data['count']); ?></p>
  <p>上次登录IP：<?php echo ($ip); ?>  上次登录的地方是：<?php echo ($addres2); ?>&nbsp;&nbsp;<?php echo ($addres); ?>&nbsp;  上次登录时间：<?php echo (date('Y-m-d H:i:s',$data['lasttime'])); ?></p>
