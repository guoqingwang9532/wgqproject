...
<link rel="stylesheet" href="/wgqproject/Public/Backend/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
<!--[if IE 6]>
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<tr class="text-c va-m">
						...
						<td>001</td>
						<td><a onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img width="60" class="product-thumb" src="/wgqproject/Public/Backend/pic/product/Thumb/6204.jpg">
						<!--这是缩略图-->
						
						</a></td>·
						<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img title="国内品牌" src="/wgqproject/Public/Backend/images/gq/cn.gif"> <b class="text-success">圣象</b> 哥本哈根橡木地板KS8373</a></td>
...
<script type="text/javascript" src="/wgqproject/Public/Backend/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script> 
