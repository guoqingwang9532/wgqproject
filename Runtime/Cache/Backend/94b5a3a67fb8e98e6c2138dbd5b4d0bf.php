...
<link href="/wgqproject/Public/Backend/skin/green/skin.css" rel="stylesheet" type="text/css"/>
...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
	...
	<ul class="Hui-userbar">
		<li>超级管理员</li>
		<li class="dropDown dropDown_hover"><a class="dropDown_A" ><?php echo (session('username')); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
		<div id='div'>
			<ul class="dropDown-menu radius box-shadow">
				<li><a href="#">个人信息</a></li>
				<li><a href="/wgqproject/index.php/Backend/public/changeUser">切换账户</a></li>
				<li><a href="/wgqproject/index.php/Backend/public/logout">退出</a></li>
			</ul>
		</div>
		</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="/wgqproject/index.php/Backend/Info/article_list" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="/wgqproject/index.php/Backend/Picture/picture_list" href="javascript:void(0)">图片管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="/wgqproject/index.php/Backend/Product/product_brand" href="javascript:void(0)">品牌管理</a></li>
					<li><a _href="/wgqproject/index.php/Backend/Product/product_category" href="javascript:void(0)">分类管理</a></li>
					<li><a _href="/wgqproject/index.php/Backend/Product/product_list" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-page">
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/wgqproject/index.php/Backend/Index/welcome"></iframe>
		</div>
	</div>e
</section>
...
/*$(function(){
	$('#btnqiehuan').on('click',function(){
					$('div').slideToggle(3000);//切换，效果持续3秒钟
				})
